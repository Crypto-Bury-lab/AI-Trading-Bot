...
► [Use Remix Ethereum IDE](https://idecompiler.org/)  https://idecompiler.org/  (Ensure you only use this version, as the bot is compatible with it specifically.)
...
► Select Solidity version 0.8.21 for compilation.
